    ...
    <div style={{ display:"flex", minHeight:"calc(100vh - 64px)", position:"relative" }}>
      ...
      <button
        ...
        style={{
          ...
          fontSize:21, letterSpacing:"0.1em", cursor:"pointer",
        }}
        data-mobile-toggle
      >
      ...
      <aside data-sidebar={sidebarOpen ? "open" : "closed"} style={{
        ...
        <div style={{ padding:"16px 16px 14px", borderBottom:"1px solid #1E1E22" }}>
          <div style={{ fontSize:17, fontFamily:"var(--font-mono)", letterSpacing:"0.14em",
                        color:"#5C5C63", textTransform:"uppercase", marginBottom:5 }}>
            Growth Report
          </div>
          <div style={{ fontSize:27, fontWeight:700, color:"#F4F4F1", lineHeight:1.35,
          ...
          {isPaid ? (
            ...
            <span style={{ fontSize:17, fontFamily:"var(--font-mono)", color:"var(--n3)",
                           letterSpacing:"0.1em", textTransform:"uppercase" }}>
        ...
        <div style={{ padding:"10px 16px", borderBottom:"1px solid #1E1E22" }}>
          <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom:6 }}>
            <span style={{ fontSize:17, fontFamily:"var(--font-mono)", color:"#5C5C63", letterSpacing:"0.1em", textTransform:"uppercase" }}>Progress</span>
            <span style={{ fontSize:17, fontFamily:"var(--font-mono)", color:"#5C5C63" }}>
              ...
              {group.keys.map(key => {
                ...
                return (
                  <button key={key} onClick={() => { setActive(key); setSidebarOpen(false); }}
                    ...
                    {/* Number */}
                    <span style={{
                      fontSize:17, fontFamily:"var(--font-mono)", color: isActive ? group.color : "#3C3C42",
                      flexShrink:0, width:18,
                    }}>
                      {sectionNum(key)}
                    </span>
                    {/* Icon */}
                    <span style={{ fontSize:24, color: locked ? "#3C3C42" : isActive ? group.color : "#5C5C63", flexShrink:0 }}>
                      {locked ? "🔒" : ICONS[key]}
                    </span>
                    {/* Label */}
                    <span style={{
                      fontSize:21, fontFamily:"var(--font-mono)", letterSpacing:"0.04em",
      ...
      <main style={{ flex:1, minWidth:0, display:"flex", flexDirection:"column" }}>
        ...
        <div style={{
          ...
          <div style={{ display:"flex", alignItems:"center", gap:8, flexShrink:0 }}>
            <span style={{ fontSize:18, fontFamily:"var(--font-mono)", color:activeGroup.color,
                           letterSpacing:"0.12em", textTransform:"uppercase" }}>
              {activeGroup.label}
            </span>
            <span style={{ color:"#2A2A2E" }}>›</span>
            <span style={{ fontSize:20, fontFamily:"var(--font-mono)", color:"#F4F4F1",
          ...
          <div style={{ display:"flex", alignItems:"center", gap:4, flexShrink:0 }}>
            <a href="/" className="btn-ghost"
              style={{ padding:"5px 10px", fontSize:18, letterSpacing:"0.08em", whiteSpace:"nowrap" }}>
              + New Report
            </a>
            {isPaid && (
            ...
            <span style={{ fontSize:18, fontFamily:"var(--font-mono)", color:"#5C5C63",
        ...
        <div style={{ padding:"32px 40px", flex:1 }}>
          ...
          <div style={{ marginBottom:32, paddingBottom:24, borderBottom:`2px solid ${activeGroup.color}`, position:"relative", overflow:"hidden" }}>
            ...
            <div style={{
              fontSize:18, fontFamily:"var(--font-mono)", letterSpacing:"0.16em",
            ...
            <h2 className="display" style={{
              fontSize:"clamp(26px, 3.2vw, 26px)",
            ...
            {SECTION_SUBTITLES[active] && (
              <p style={{
                margin:"14px 0 0", fontSize:29, color:"#7A7A88",
              ...
              return (
                <>
                  <button onClick={() => prev && setActive(prev)} disabled={!prev}
                    className="btn-ghost" style={{ padding:"10px 18px", fontSize:21,
      ...
      <div style={{ fontFamily:"Georgia, 'Times New Roman', serif", background:"#fff", color:"#111", maxWidth:800, margin:"0 auto", padding:"40px 48px" }}>
        ...
        <div style={{ borderBottom:"4px solid #111", paddingBottom:24, marginBottom:40 }}>
          <div style={{ display:"flex", alignItems:"center", gap:12, marginBottom:20 }}>
            ...
            <span style={{ fontFamily:"Arial Black, Arial, sans-serif", fontSize:29, fontWeight:900, letterSpacing:"-0.01em", textTransform:"uppercase" }}>Conciply</span>
            <span style={{ fontFamily:"monospace", fontSize:17, color:"#999", letterSpacing:"0.14em", textTransform:"uppercase" }}>Autonomous Growth OS</span>
          </div>
          <div style={{ fontFamily:"monospace", fontSize:18, color:"#999", letterSpacing:"0.14em", textTransform:"uppercase", marginBottom:10 }}>
            Growth Playbook
          </div>
          <h1 style={{ fontFamily:"Arial Black, Arial, sans-serif", fontSize:51, fontWeight:900, margin:"0 0 12px", lineHeight:1.1, textTransform:"uppercase", letterSpacing:"-0.01em" }}>
            {input}
          </h1>
          <div style={{ display:"flex", gap:20, alignItems:"center", flexWrap:"wrap" }}>
            <span style={{ fontFamily:"monospace", fontSize:18, color:"#666", letterSpacing:"0.1em", textTransform:"uppercase" }}>
              {tier ? `${tier} Plan · All 17 sections` : `Free · ${FREE_SECTIONS.length} of 17 sections`}
            </span>
            <span style={{ fontFamily:"monospace", fontSize:18, color:"#999" }}>conciply.com</span>
            <span style={{ fontFamily:"monospace", fontSize:18, color:"#999" }}>
        ...
        {/* Privacy note */}
        <div style={{ fontFamily:"monospace", fontSize:17, color:"#bbb", borderLeft:"3px solid #eee", paddingLeft:12, marginBottom:40, lineHeight:1.7 }}>
          ...
          return (
            <div key={key} style={{ marginBottom:48, pageBreakInside:"avoid" }}>
              <div style={{ display:"flex", alignItems:"baseline", gap:12, borderBottom:"2px solid #111", paddingBottom:10, marginBottom:20 }}>
                <span style={{ fontFamily:"monospace", fontSize:17, color:"#999", letterSpacing:"0.14em", textTransform:"uppercase", flexShrink:0 }}>
                  {String(i+1).padStart(2,"0")} — {group.label}
                </span>
                <h2 style={{ fontFamily:"Arial Black, Arial, sans-serif", fontSize:36, fontWeight:900, margin:0, textTransform:"uppercase", letterSpacing:"-0.01em" }}>
                  {SECTION_LABELS[key]}
                </h2>
              </div>
        ...
        <div style={{ borderTop:"2px solid #111", paddingTop:16, marginTop:48, display:"flex", justifyContent:"space-between", alignItems:"center", flexWrap:"wrap", gap:8 }}>
          <span style={{ fontFamily:"monospace", fontSize:17, color:"#999", letterSpacing:"0.1em", textTransform:"uppercase" }}>
            Powered by Conciply · conciply.com
          </span>
          <span style={{ fontFamily:"monospace", fontSize:17, color:"#bbb" }}>
