  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <p style={{ fontSize: 14, color: "#9A9AA8", lineHeight: 1.65, marginBottom: 32 }}>
        ...
        <label style={{ display: "flex", alignItems: "flex-start", gap: 12,
          ...
          <input
            ...
            style={{ marginTop: 3, width: 16, height: 16, flexShrink: 0,
                     accentColor: "var(--n1)", cursor: "pointer" }}
          />
          <span style={{ fontSize: 14, color: "#C4C4CC", lineHeight: 1.6 }}>
        ...
        <button
          ...
          disabled={!checked}
          className="btn-neon"
          style={{ width: "100%", padding: "14px 0", fontSize: 13, fontWeight: 700,
                   opacity: checked ? 1 : 0.35, cursor: checked ? "pointer" : "not-allowed",
